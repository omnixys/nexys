...
export enum SecurityQuestionEnum {
  ...
  ChildhoodBestFriend = "CHILDHOOD_BEST_FRIEND",
  FavoriteSchoolSubject = "FAVORITE_SCHOOL_SUBJECT",
  FavouriteCompany = "FAVOURITE_COMPANY",
  FirstPet = "FIRST_PET",
...
export type GetAllCountriesQuery = {
  ...
  getAllCountries: Array<{
    ...
    flagPng?: string | null;
    iso2: string;
    callingCode?: { __typename?: "CallingCode"; id: string; code: string } | null;
  }>;
};
...
export type GetCitiesByPostalCodeQuery = {
  __typename?: "Query";
  getCitiesByPostalCode: { __typename?: "City"; id: string; name: string };
};
...
export type GetCitiesByStateQuery = {
  __typename?: "Query";
  getCitiesByState?: Array<{ __typename?: "City"; id: string; name: string }> | null;
};
...
export type GetPostalCodesByCityQuery = {
  __typename?: "Query";
  getPostalCodesByCity?: Array<{ __typename?: "PostalCode"; id: string; code: string }> | null;
};
...
export type GetPostalCodesByStateQuery = {
  __typename?: "Query";
  getPostalCodesByState?: Array<{ __typename?: "PostalCode"; id: string; code: string }> | null;
};
...
export type GetStatesByCountryQuery = {
  __typename?: "Query";
  getStatesByCountry: Array<{ __typename?: "State"; id: string; code: string; name: string }>;
};
...
export type GetUserAddressesByUserIdQuery = {
  __typename?: "Query";
  getUserAddressesByUserId: Array<{
    __typename?: "UserAddressPayload";
    id: string;
    userId: string;
    country?: string | null;
...
export type GenerateWebAuthnAuthOptionsMutation = {
  __typename?: "Mutation";
  generateWebAuthnAuthOptions: any;
};
...
export type LoginCredentialsMutation = {
  __typename?: "Mutation";
  credentialsLogin: {
    __typename?: "TokenPayload";
    accessToken: string;
...
export type LogoutMutation = {
  __typename?: "Mutation";
  logout: { __typename?: "SuccessPayload"; ok: boolean };
};
...
export type VerifyPasswordResetStepUpMutation = {
  __typename?: "Mutation";
...
export type VerifyPasswordResetTokenMutation = {
  __typename?: "Mutation";
...
export type VerifyWebAuthnAuthenticationMutation = {
  __typename?: "Mutation";
...
export type CreateSignupVerificationMutation = {
  __typename?: "Mutation";
  createSignupVerification: boolean;
};
...
export type GetAllInterestCategoriesQuery = {
  __typename?: "Query";
  getAllInterestCategories: Array<{
    __typename?: "InterestCategoryPayload";
    id: string;
    key: InterestCategoryEnum;
    icon?: string | null;
...
export type GetAllInterestsQuery = {
  __typename?: "Query";
  getAllInterests: Array<{
    __typename?: "InterestPayload";
    id: string;
    key: InterestEnum;
    icon?: string | null;
  ...
  me: {
    ...
    customer?: {
      ...
      customerInterest?: Array<{
        ...
        id: string;
        isPrimary?: boolean | null;
        interest?: { __typename?: "InterestPayload"; key: InterestEnum } | null;
      }> | null;
    } | null;
    employee?: {
      __typename?: "EmployeePayload";
...
export const AutocompleteAddressDocument = {
  kind: "Document",
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "addressAutocomplete" },
            arguments: [
              {
                kind: "Argument",
...
} as unknown as DocumentNode<AutocompleteAddressQuery, AutocompleteAddressQueryVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "flagSvg" } },
                { kind: "Field", name: { kind: "Name", value: "flagPng" } },
                { kind: "Field", name: { kind: "Name", value: "iso2" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "callingCode" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
...
export const GetCitiesByPostalCodeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetCitiesByPostalCode" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "postalCodeId" } },
          type: {
            kind: "NonNullType",
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "postalCodeId" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
...
} as unknown as DocumentNode<GetCitiesByPostalCodeQuery, GetCitiesByPostalCodeQueryVariables>;
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "stateId" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
...
} as unknown as DocumentNode<GetCitiesByStateQuery, GetCitiesByStateQueryVariables>;
export const GetPostalCodesByCityDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetPostalCodesByCity" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<GetPostalCodesByCityQuery, GetPostalCodesByCityQueryVariables>;
export const GetPostalCodesByStateDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<GetPostalCodesByStateQuery, GetPostalCodesByStateQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetStatesByCountry" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "countryId" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "ID" } },
          },
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "countryId" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
...
} as unknown as DocumentNode<GetStatesByCountryQuery, GetStatesByCountryQueryVariables>;
export const GetUserAddressesByUserIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUserAddressesByUserId" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<GetUserAddressesByUserIdQuery, GetUserAddressesByUserIdQueryVariables>;
export const ValidateAddressDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "AddressValidationInput" } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<ValidateAddressQuery, ValidateAddressQueryVariables>;
export const CompletePasswordResetDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CompletePasswordReset" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "input" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "CompleteResetInputGql" } },
          },
        },
      ],
      selectionSet: {
...
export const GenerateWebAuthnAuthOptionsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "GenerateWebAuthnAuthOptions" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "generateWebAuthnAuthOptions" } },
        ],
      },
    },
  ],
...
>;
export const GetSecurityQuestionsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetSecurityQuestions" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<GetSecurityQuestionsQuery, GetSecurityQuestionsQueryVariables>;
export const LoginCredentialsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "LoginCredentials" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "input" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "credentialsLogin" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "input" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "refreshExpiresIn" } },
...
} as unknown as DocumentNode<LoginCredentialsMutation, LoginCredentialsMutationVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "LoginTotp" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<LoginTotpMutation, LoginTotpMutationVariables>;
...
} as unknown as DocumentNode<SendMagicLinkMutation, SendMagicLinkMutationVariables>;
export const VerifyPasswordResetStepUpDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "VerifyPasswordResetStepUp" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "input" } },
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "StepUpVerificationInputGql" },
            },
          },
        },
      ],
...
} as unknown as DocumentNode<VerifyMagicLinkMutation, VerifyMagicLinkMutationVariables>;
...
} as unknown as DocumentNode<VerifySignUpMutation, VerifySignUpMutationVariables>;
export const VerifyWebAuthnAuthenticationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "VerifyWebAuthnAuthentication" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
export const GetAllInterestCategoriesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetAllInterestCategories" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<GetAllInterestCategoriesQuery, GetAllInterestCategoriesQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetAllInterests" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<GetAllInterestsQuery, GetAllInterestsQueryVariables>;
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "relationship" } },
                      { kind: "Field", name: { kind: "Name", value: "withdrawalLimit" } },
                      { kind: "Field", name: { kind: "Name", value: "emergency" } },
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "state" } },
                      { kind: "Field", name: { kind: "Name", value: "contactOptions" } },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "customerInterest" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "id" } },
