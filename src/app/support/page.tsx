...
const recentTickets = [
  ...
  {
    id: "TKT-7841",
    subject: "International transfer delay",
  ...
  {
    id: "TKT-7838",
    subject: "Investment portfolio question",
                ...
                {contactMethods.map((method) => (
                  <Box
                    ...
                    sx={{
                      p: 2,
                      borderRadius: 2,
                      bgcolor: method.available
                        ? alpha(method.color, 0.1)
                ...
                >
                  ...
                  <Box sx={{ display: "flex", gap: 1, mb: 2, justifyContent: "flex-end" }}>
                    <Box>
                      ...
                      >
                        <Typography variant="body2">
                          I'm having issues with my international transfer. It's been pending for 2
                          days.
                        </Typography>
                      </Box>
                      <Typography
                        ...
                        sx={{ mt: 0.5, mr: 1, textAlign: "right" }}
                      >
                        Just now
                      </Typography>
                    </Box>
            ...
            >
              ...
              <Box sx={{ mt: "auto", pt: 2, borderTop: "1px solid rgba(255,255,255,0.1)" }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <Typography variant="caption" color="text.secondary">
                    Current wait time:{" "}
                    <Box component="span" fontWeight={600} color="#4CAF50">
                      2 minutes
                    </Box>
                  </Typography>
                </Box>
