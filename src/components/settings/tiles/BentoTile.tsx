/**
 * @file /settings/_components/tiles/BentoTile.tsx
...
export default function BentoTile({
  ...
  return (
    <MotionCard
      ...
      sx={{
        gridColumn: area?.includes("span") ? undefined : undefined,
        gridArea: undefined,
        gridRow: undefined,
        gridColumnEnd: undefined,
        // We pass "auto / span X" via `area` into gridColumn on each tile wrapper, not via gridArea.
        // This avoids hard-coded row/col area strings and keeps the layout resilient.
