...
export default function WeatherTile(): JSX.Element {
  ...
  const temperature = isImperial ? `${toFahrenheit(WEATHER.tempC)}°F` : `${WEATHER.tempC}°C`;
  ...
  return (
    <Box p={2}>
      ...
      <Stack spacing={0.5} mt={1}>
        ...
        >
          <Typography component="div" variant="h4" fontWeight={600} sx={{ color: "text.primary" }}>
            {temperature}
          </Typography>
        </motion.div>

        {/* CONDITION */}
        <Typography component="div" variant="body2" sx={{ opacity: 0.7, color: "text.primary" }}>
